              ...
              onClick={(e) => {
                if (pathname === "/blog") {
                  ...
                  if (el) {
                    ...
                    window.history.pushState(null, "", "/blog#contact");
                  }
                }
              }}
              className="border border-cinematic-blue text-ice-blue px-5 py-2 rounded-full font-body font-medium text-[0.9rem] uppercase tracking-[0.06em] transition-colors hover:bg-cinematic-blue hover:text-charcoal-night"
              data-cursor="open"
            >
              Contact Us
            </Link>
